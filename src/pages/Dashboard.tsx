...
const Dashboard: React.FC = () => {
  ...
  return (
    <Box sx={{ p: { xs: 1.5, sm: 2, md: 3 }, maxWidth: 1200, mx: 'auto' }}>
      ...
      {/* Compliance Progress card removed — its per-framework gauges, control
          status, assessment objectives, and reciprocity now live inside the
          Program Readiness widget's click-to-expand (de-duplicated). */}
