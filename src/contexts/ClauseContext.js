...
export var ClauseContext = createContext(undefined);
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        dlog('[CLAUSES] set initial', {
                            ...
                            missing: clausesResponse.data.filter(function (c) { return !c.family; }).length
                        });
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setClauses(function (prevClauses) {
                        return prevClauses.map(function (clause) {
                            return clause.id === clauseId
                                ? __assign(__assign({}, clause), { is_bookmarked: !clause.is_bookmarked }) : clause;
                        });
                    });
                    return [3 /*break*/, 3];
                case 2:
                    err_2 = _a.sent();
                    setError(err_2 instanceof Error ? err_2.message : 'Failed to bookmark clause');
                    throw err_2;
