...
import { AppBar as MuiAppBar, Toolbar, Button, IconButton, Box, Menu, MenuItem, Avatar, Tooltip, Dialog, DialogTitle, DialogContent, DialogActions, TextField, Alert, Tabs, Tab, } from '@mui/material';
...
export var AppBar = function (_a) {
    ...
    var _l = useAuth(), user = _l.user, signOut = _l.signOut, signUp = _l.signUp;
    ...
    return (_jsxs(MuiAppBar, { position: "fixed", color: "default", elevation: 0, sx: {
            width: '100%',
            ...
            borderBottom: '1px solid rgba(148, 163, 184, 0.1)'
                                ...
                                }, indicatorColor: "secondary", textColor: "primary", children: [_jsx(Tab, { label: "Clauses" }), _jsx(Tab, { label: "Matrix" }), _jsx(Tab, { label: "Document Scanner" })] })] }), _jsxs(Box, { sx: { display: 'flex', alignItems: 'center', ml: 2 }, children: [_jsx(Tooltip, { title: "Settings", children: _jsx(IconButton, { color: "inherit", onClick: onSettingsClick, children: _jsx(SettingsIcon, {}) }) }), user ? (_jsx(Tooltip, { title: user.email || 'Account settings', children: _jsx(IconButton, { onClick: handleProfileMenuOpen, size: "small", sx: { ml: 2 }, children: _jsx(Avatar, { sx: { width: 32, height: 32 }, children: ((_c = (_b = user.email) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.toUpperCase()) || 'U' }) }) })) : (_jsxs(_Fragment, { children: [_jsx(Button, { color: "inherit", onClick: function () { return setLoginOpen(true); }, sx: { ml: 2 }, children: "Login" }), _jsx(Button, { color: "secondary", variant: "contained", onClick: function () { return setSignUpOpen(true); }, sx: { ml: 1 }, children: "Sign Up" })] }))] })] }), _jsxs(Menu, { anchorEl: anchorEl, open: Boolean(anchorEl), onClose: handleMenuClose, onClick: handleMenuClose, children: [_jsx(MenuItem, { disabled: true, children: user === null || user === void 0 ? void 0 : user.email }), _jsx(MenuItem, { children: "Profile" }), _jsx(MenuItem, { children: "My Account" }), _jsx(MenuItem, { onClick: handleLogout, children: "Logout" })] }), _jsxs(Dialog, { open: loginOpen, onClose: function () { return setLoginOpen(false); }, maxWidth: "xs", fullWidth: true, children: [_jsx(DialogTitle, { children: "Sign In" }), _jsx(DialogContent, { children: _jsx(SignIn, {}) }), _jsx(DialogActions, { children: _jsx(Button, { onClick: function () { return setLoginOpen(false); }, children: "Close" }) })] }), _jsxs(Dialog, { open: signUpOpen, onClose: function () { return setSignUpOpen(false); }, maxWidth: "xs", fullWidth: true, children: [_jsx(DialogTitle, { children: "Sign Up" }), _jsx(DialogContent, { children: _jsxs("form", { onSubmit: handleSignUp, children: [_jsx(TextField, { label: "Email", type: "email", value: signUpEmail, onChange: function (e) { return setSignUpEmail(e.target.value); }, fullWidth: true, margin: "normal", required: true }), _jsx(TextField, { label: "Password", type: "password", value: signUpPassword, onChange: function (e) { return setSignUpPassword(e.target.value); }, fullWidth: true, margin: "normal", required: true }), signUpError && _jsx(Alert, { severity: "error", children: signUpError }), _jsxs(DialogActions, { children: [_jsx(Button, { onClick: function () { return setSignUpOpen(false); }, children: "Cancel" }), _jsx(Button, { type: "submit", variant: "contained", color: "primary", disabled: signUpLoading, children: signUpLoading ? 'Signing Up...' : 'Sign Up' })] })] }) })] })] }));
};
