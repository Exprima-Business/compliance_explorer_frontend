...
export declare const BookmarkedClauses: ({ bookmarkedClauses, onClauseClick, onBookmarkToggle }: BookmarkedClausesProps) => import("react/jsx-runtime").JSX.Element | null;
export {};
